...
export const metadata = {
  title: "Convênios Nacionais - RIDEP | Universidades Brasileiras",
  description: "Convênios estabelecidos pela RIDEP com universidades brasileiras. Parcerias para pesquisas e colaborações em desenvolvimento profissional de professores no contexto nacional.",
  keywords: "RIDEP, convênios nacionais, universidades brasileiras, parcerias nacionais, pesquisa educacional Brasil",
};

export default function ConveniosNacionais() {
  ...
  return (
    <div className="pt-16 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <SectionTitle title="Convênios Nacionais" />

        {/* Descrição */}
        <section className="mb-8">
          <p className="text-lg text-gray-900 max-w-3xl">
            A RIDEP mantém convênios com universidades brasileiras para promover pesquisas e
            colaborações em desenvolvimento profissional de professores no contexto nacional.
          </p>
        </section>
